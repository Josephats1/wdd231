...
class App {
        ...
        try {
            ...
            const processedData = successStories
                ...
                .map(story => ({
                    ...
                    placeholder: 'data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAxMDAgMTAwIj48cmVjdCB3aWR0aD0iMTAwIiBoZWlnaHQ9IjEwMCIgZmlsbD0iI2VlZSIvPjwvc3ZnPg=='
                }));
    ...
    displayData(stories) {
        ...
        stories.forEach(story => {
            ...
            dataItem.innerHTML = `
                <h3>${story.title}</h3>
                <img src="${story.placeholder}" 
                     data-src="images/${story.image}" 
                     alt="${story.title} in ${story.location}" 
                     loading="lazy" 
                     class="story-image lazy">
